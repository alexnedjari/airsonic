    ...
    <tr style="vertical-align:top;">
        <td style="vertical-align:top;padding-bottom: 1em">
            <table class="music" style="width: 100%">
                <c:forEach items="${model.files}" var="song" varStatus="loopStatus">
                    <%--@elvariable id="song" type="org.minisonic.player.domain.MediaFile"--%>
        ...
        <c:if test="${model.showAd}">
            <td style="vertical-align:top;width:160px" rowspan="3">
                <h2 style="padding-bottom: 1em">Minisonic Premium</h2>
                <p style="font-size: 90%">
                    Upgrade to Minisonic Premium and get:
                </p>
                <div style="font-size: 90%;padding-bottom: 1em">
                    <p><a href="https://minisonic.github.io/docs/apps/" target="_blank">Apps</a> for Android, iPhone, Windows Phone ++.</p>
                    <p>Video streaming.</p>
                    <p>Chromecast and Sonos support.</p>
                    <p>DLNA/UPnP support</p>
                    <p>Share on Facebook, Twitter, Google+</p>
                    <p>No ads.</p>
                    <p>Your personal server address: <em>you</em>.minisonic.org</p>
