...
import org.minisonic.player.domain.Version;
 ...
 * version of Minisonic is available.
 *
 * @author Sindre Mehus
 */
@Service
public class VersionService {
    ...
    /**
     * Returns the version number for the locally installed Minisonic version.
     *
     * @return The version number for the locally installed Minisonic version.
     */
    public synchronized Version getLocalVersion() {
        if (localVersion == null) {
            try {
                localVersion = new Version(readLineFromResource("/version.txt"));
                LOG.info("Resolved local Minisonic version to: " + localVersion);
            } catch (Exception x) {
                LOG.warn("Failed to resolve local Minisonic version.", x);
            }
        }
        return localVersion;
    }
    ...
    /**
     * Returns the version number for the latest available Minisonic final version.
     *
     * @return The version number for the latest available Minisonic final version, or <code>null</code>
    ...
    /**
     * Returns the version number for the latest available Minisonic beta version.
     *
     * @return The version number for the latest available Minisonic beta version, or <code>null</code>
     *         if the version number can't be resolved.
     */
    ...
    /**
     * Returns the build date for the locally installed Minisonic version.
     *
     * @return The build date for the locally installed Minisonic version, or <code>null</code>
    ...
    public synchronized Date getLocalBuildDate() {
        if (localBuildDate == null) {
            try {
                ...
                LOG.warn("Failed to resolve local Minisonic build date.", x);
            }
        }
    ...
    /**
     * Returns the build number for the locally installed Minisonic version.
     *
     * @return The build number for the locally installed Minisonic version, or <code>null</code>
    ...
    public synchronized String getLocalBuildNumber() {
        if (localBuildNumber == null) {
            try {
                ...
                LOG.warn("Failed to resolve local Minisonic build number.", x);
            }
        }
    ...
    /**
     * Returns whether a new final version of Minisonic is available.
     *
     * @return Whether a new final version of Minisonic is available.
     */
    ...
    /**
     * Returns whether a new beta version of Minisonic is available.
     *
     * @return Whether a new beta version of Minisonic is available.
     */
    ...
    private void refreshLatestVersion() {
        ...
        if (isOutdated) {
            try {
                ...
                LOG.warn("Failed to resolve latest Minisonic version.", x);
            }
        }
    }
    ...
    private static final String VERSION_URL = "https://api.github.com/repos/minisonic/minisonic/releases";

    /**
     * Resolves the latest available Minisonic version by inspecting github.
     */
