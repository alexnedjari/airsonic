...
<div id="placeholder-${param.topic}" style="display:none">
    <div style="font-weight:bold;"><fmt:message key="helppopup.${param.topic}.title"><fmt:param value="Minisonic"/></fmt:message></div>
    <div><fmt:message key="helppopup.${param.topic}.text"><fmt:param value="Minisonic"/></fmt:message></div>
</div>
