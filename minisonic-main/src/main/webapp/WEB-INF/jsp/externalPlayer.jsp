...
<head>
    ...
    <script type="text/javascript">
        ...
        <c:forEach items="${model.songs}" var="song" varStatus="loopStatus">
            <%--@elvariable id="song" type="org.minisonic.player.domain.MediaFileWithUrlInfo"--%>
...
<div style="margin:auto;width:500px">
    ...
    <div class="detail" style="float:right">Streaming by <a href="https://minisonic.github.io/" target="_blank"><b>Minisonic</b></a></div>
