...
import org.minisonic.player.io.PlayQueueInputStream;
import org.minisonic.player.io.RangeOutputStream;
import org.minisonic.player.io.ShoutCastOutputStream;
import org.minisonic.player.security.JWTAuthenticationToken;
import org.minisonic.player.service.*;
import org.minisonic.player.service.sonos.SonosHelper;
import org.minisonic.player.util.HttpRange;
    ...
    public void handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            in = new PlayQueueInputStream(player, status, maxBitRate, preferredTargetFormat, videoTranscodingSettings, transcodingService,
                    mediaFileService, searchService);
            ...
            if (isShoutCastRequested && !isSingleFile) {
                ...
                response.setHeader("icy-notice1", "This stream is served using Minisonic");
                response.setHeader("icy-notice2", "Minisonic - Free media streamer");
                response.setHeader("icy-name", "Minisonic");
                response.setHeader("icy-genre", "Mixed");
                response.setHeader("icy-url", "https://minisonic.github.io/");
