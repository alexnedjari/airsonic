...
//            diff("en", locale);
    ...
    private static void diff(String locale1, String locale2) throws IOException {
        ...
        en.load(MissingTranslations.class.getResourceAsStream("/org/minisonic/player/i18n/ResourceBundle_" + locale1 + ".properties"));
        SortedMap<Object,Object> enSorted = new TreeMap<Object, Object>(en);

        Properties mk = new Properties();
        mk.load(MissingTranslations.class.getResourceAsStream("/org/minisonic/player/i18n/ResourceBundle_" + locale2 + ".properties"));
