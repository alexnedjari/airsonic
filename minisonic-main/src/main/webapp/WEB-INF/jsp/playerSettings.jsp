...
<%--@elvariable id="command" type="org.minisonic.player.command.PlayerSettingsCommand"--%>
...
<c:if test="${settings_reload}">
    <script  type="text/javascript">parent.frames.playQueue.location.href="playQueue.view?"</script>
</c:if>
