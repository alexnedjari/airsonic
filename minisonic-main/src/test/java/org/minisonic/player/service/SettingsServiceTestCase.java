...
public class SettingsServiceTestCase extends TestCase {
    ...
    protected void setUp() throws Exception {
        String minisonicHome = TestCaseUtils.minisonicHomePathForTest();
        System.setProperty("minisonic.home", minisonicHome);
        new File(minisonicHome, "minisonic.properties").delete();
    ...
    public void testMinisonicHome() {
        assertEquals("Wrong Minisonic home.", TestCaseUtils.minisonicHomePathForTest(), SettingsService.getMinisonicHome().getAbsolutePath());
    }
