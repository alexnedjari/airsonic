...
import static org.minisonic.player.security.RESTRequestParameterProcessingFilter.decrypt;
...
import org.minisonic.player.ajax.PlayQueueService;
import org.minisonic.player.command.UserSettingsCommand;
import org.minisonic.player.dao.AlbumDao;
import org.minisonic.player.dao.ArtistDao;
import org.minisonic.player.dao.MediaFileDao;
import org.minisonic.player.dao.PlayQueueDao;
import org.minisonic.player.domain.Album;
import org.minisonic.player.domain.Bookmark;
import org.minisonic.player.domain.InternetRadio;
import org.minisonic.player.domain.MediaFile;
import org.minisonic.player.domain.MusicFolderContent;
import org.minisonic.player.domain.MusicIndex;
import org.minisonic.player.domain.PlayStatus;
import org.minisonic.player.domain.Player;
import org.minisonic.player.domain.PlayerTechnology;
import org.minisonic.player.domain.RandomSearchCriteria;
import org.minisonic.player.domain.SavedPlayQueue;
import org.minisonic.player.domain.SearchCriteria;
import org.minisonic.player.domain.TranscodeScheme;
import org.minisonic.player.domain.UserSettings;
import org.minisonic.player.service.BookmarkService;
import org.minisonic.player.service.JukeboxService;
import org.minisonic.player.service.MediaFileService;
import org.minisonic.player.service.MediaScannerService;
import org.minisonic.player.service.MusicIndexService;
import org.minisonic.player.service.PlayerService;
import org.minisonic.player.service.PlaylistService;
import org.minisonic.player.service.PodcastService;
import org.minisonic.player.service.RatingService;
...
import org.minisonic.restapi.AlbumID3;
import org.minisonic.restapi.AlbumList;
import org.minisonic.restapi.AlbumList2;
import org.minisonic.restapi.AlbumWithSongsID3;
import org.minisonic.restapi.ArtistID3;
import org.minisonic.restapi.ArtistWithAlbumsID3;
import org.minisonic.restapi.ArtistsID3;
import org.minisonic.restapi.Bookmarks;
import org.minisonic.restapi.Child;
import org.minisonic.restapi.Directory;
import org.minisonic.restapi.Index;
import org.minisonic.restapi.IndexID3;
import org.minisonic.restapi.Indexes;
import org.minisonic.restapi.InternetRadioStation;
import org.minisonic.restapi.InternetRadioStations;
import org.minisonic.restapi.JukeboxPlaylist;
import org.minisonic.restapi.JukeboxStatus;
import org.minisonic.restapi.License;
import org.minisonic.restapi.MediaType;
import org.minisonic.restapi.MusicFolders;
import org.minisonic.restapi.NewestPodcasts;
import org.minisonic.restapi.NowPlaying;
import org.minisonic.restapi.NowPlayingEntry;
import org.minisonic.restapi.PlaylistWithSongs;
import org.minisonic.restapi.Playlists;
import org.minisonic.restapi.PodcastStatus;
import org.minisonic.restapi.Podcasts;
import org.minisonic.restapi.Response;
import org.minisonic.restapi.ScanStatus;
import org.minisonic.restapi.SearchResult2;
import org.minisonic.restapi.SearchResult3;
import org.minisonic.restapi.Shares;
import org.minisonic.restapi.Songs;
import org.minisonic.restapi.Starred;
import org.minisonic.restapi.Starred2;
import org.minisonic.restapi.Users;
import org.minisonic.restapi.Videos;
...
public class MinisonicRESTController {

    private static final Logger LOG = LoggerFactory.getLogger(MinisonicRESTController.class);
    ...
    private final Map<BookmarkKey, org.minisonic.player.domain.Bookmark> bookmarkCache = new ConcurrentHashMap<BookmarkKey, org.minisonic.player.domain.Bookmark>();
    ...
    public void getLicense(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        license.setEmail("minisonic@github.com");
    ...
    public void getMusicFolders(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (org.minisonic.player.domain.MusicFolder musicFolder : settingsService.getMusicFoldersForUser(username)) {
            org.minisonic.restapi.MusicFolder mf = new org.minisonic.restapi.MusicFolder();
    ...
    public void getIndexes(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List<org.minisonic.player.domain.MusicFolder> musicFolders = settingsService.getMusicFoldersForUser(username);
        Integer musicFolderId = getIntParameter(request, "musicFolderId");
        if (musicFolderId != null) {
            for (org.minisonic.player.domain.MusicFolder musicFolder : musicFolders) {
            ...
            for (MusicIndex.SortableArtistWithMediaFiles artist : entry.getValue()) {
                for (MediaFile mediaFile : artist.getMediaFiles()) {
                    if (mediaFile.isDirectory()) {
                        ...
                        org.minisonic.restapi.Artist a = new org.minisonic.restapi.Artist();
    ...
    public void getGenres(HttpServletRequest request, HttpServletResponse response) throws Exception {
        request = wrapRequest(request);
        org.minisonic.restapi.Genres genres = new org.minisonic.restapi.Genres();

        for (org.minisonic.player.domain.Genre genre : mediaFileDao.getGenres(false)) {
            org.minisonic.restapi.Genre g = new org.minisonic.restapi.Genre();
    ...
    public void getSongsByGenre(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        Integer musicFolderId = getIntParameter(request, "musicFolderId");
        List<org.minisonic.player.domain.MusicFolder> musicFolders = settingsService.getMusicFoldersForUser(username, musicFolderId);
    ...
    public void getArtists(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List<org.minisonic.player.domain.Artist> artists = artistDao.getAlphabetialArtists(0, Integer.MAX_VALUE, musicFolders);
    ...
    private <T extends ArtistID3> T createJaxbArtist(T jaxbArtist, org.minisonic.player.domain.Artist artist, String username) {
    ...
    private org.minisonic.restapi.Artist createJaxbArtist(MediaFile artist, String username) {
        org.minisonic.restapi.Artist result = new org.minisonic.restapi.Artist();
    ...
    public void getArtist(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        org.minisonic.player.domain.Artist artist = artistDao.getArtist(id);
        if (artist == null) {
    ...
    private <T extends AlbumID3> T createJaxbAlbum(T jaxbAlbum, Album album, String username) {
        ...
        if (album.getArtist() != null) {
            ...
            org.minisonic.player.domain.Artist artist = artistDao.getArtist(album.getArtist());
            if (artist != null) {
    ...
    private <T extends org.minisonic.restapi.Playlist> T createJaxbPlaylist(T jaxbPlaylist, org.minisonic.player.domain.Playlist playlist) {
    ...
    public void search(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        org.minisonic.player.domain.SearchResult result = searchService.search(criteria, musicFolders, SearchService.IndexType.SONG);
        org.minisonic.restapi.SearchResult searchResult = new org.minisonic.restapi.SearchResult();
    ...
    public void search2(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        org.minisonic.player.domain.SearchResult artists = searchService.search(criteria, musicFolders, SearchService.IndexType.ARTIST);
        ...
        org.minisonic.player.domain.SearchResult albums = searchService.search(criteria, musicFolders, SearchService.IndexType.ALBUM);
        ...
        org.minisonic.player.domain.SearchResult songs = searchService.search(criteria, musicFolders, SearchService.IndexType.SONG);
    ...
    public void search3(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        criteria.setCount(getIntParameter(request, "artistCount", 20));
        criteria.setOffset(getIntParameter(request, "artistOffset", 0));
        org.minisonic.player.domain.SearchResult result = searchService.search(criteria, musicFolders, SearchService.IndexType.ARTIST_ID3);
        for (org.minisonic.player.domain.Artist artist : result.getArtists()) {
    ...
    public void getPlaylists(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        org.minisonic.player.domain.User user = securityService.getCurrentUser(request);
        ...
        for (org.minisonic.player.domain.Playlist playlist : playlistService.getReadablePlaylistsForUser(requestedUsername)) {
            result.getPlaylist().add(createJaxbPlaylist(new org.minisonic.restapi.Playlist(), playlist));
        }
    ...
    public void getPlaylist(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        org.minisonic.player.domain.Playlist playlist = playlistService.getPlaylist(id);
        if (playlist == null) {
    ...
    public void jukeboxControl(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        org.minisonic.player.domain.PlayQueue playQueue = player.getPlayQueue();


        int currentIndex = controlsJukebox && !playQueue.isEmpty() ? playQueue.getIndex() : -1;
        boolean playing = controlsJukebox && !playQueue.isEmpty() && playQueue.getStatus() == org.minisonic.player.domain.PlayQueue.Status.PLAYING;
    ...
    public void createPlaylist(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        org.minisonic.player.domain.Playlist playlist;
        if (playlistId != null) {
            ...
            playlist = new org.minisonic.player.domain.Playlist();
...
//            }
    ...
    private <T extends Child> T createJaxbChild(T child, Player player, MediaFile mediaFile, String username) {
        ...
        if (mediaFile.isFile()) {
            ...
            org.minisonic.player.domain.Bookmark bookmark = bookmarkCache.get(new BookmarkKey(username, mediaFile.getId()));
            if (bookmark != null) {
            ...
            if (mediaFile.getArtist() != null) {
                org.minisonic.player.domain.Artist artist = artistDao.getArtist(mediaFile.getArtist());
                if (artist != null) {
    ...
    private String getRelativePath(MediaFile musicFile) {
        ...
        List<org.minisonic.player.domain.MusicFolder> musicFolders = settingsService.getAllMusicFolders(false, true);
        for (org.minisonic.player.domain.MusicFolder musicFolder : musicFolders) {
    ...
    private void starOrUnstar(HttpServletRequest request, HttpServletResponse response, boolean star) throws Exception {
        ...
        for (int artistId : getIntParameters(request, "artistId")) {
            org.minisonic.player.domain.Artist artist = artistDao.getArtist(artistId);
            if (artist == null) {
    ...
    public void getStarred2(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (org.minisonic.player.domain.Artist artist : artistDao.getStarredArtists(0, Integer.MAX_VALUE, username, musicFolders)) {
    ...
    public void getPodcasts(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (org.minisonic.player.domain.PodcastChannel channel : podcastService.getAllChannels()) {
            if (channelId == null || channelId.equals(channel.getId())) {

                org.minisonic.restapi.PodcastChannel c = new org.minisonic.restapi.PodcastChannel();
                ...
                if (includeEpisodes) {
                    List<org.minisonic.player.domain.PodcastEpisode> episodes = podcastService.getEpisodes(channel.getId());
                    for (org.minisonic.player.domain.PodcastEpisode episode : episodes) {
    ...
    public void getNewestPodcasts(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (org.minisonic.player.domain.PodcastEpisode episode : podcastService.getNewestEpisodes(count)) {
    ...
    private org.minisonic.restapi.PodcastEpisode createJaxbPodcastEpisode(Player player, String username, org.minisonic.player.domain.PodcastEpisode episode) {
        org.minisonic.restapi.PodcastEpisode e = new org.minisonic.restapi.PodcastEpisode();

        String path = episode.getPath();
        if (path != null) {
            MediaFile mediaFile = mediaFileService.getMediaFile(path);
            e = createJaxbChild(new org.minisonic.restapi.PodcastEpisode(), player, mediaFile, username);
    ...
    public void downloadPodcastEpisode(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        int id = getRequiredIntParameter(request, "id");
        org.minisonic.player.domain.PodcastEpisode episode = podcastService.getEpisode(id, true);
        if (episode == null) {
    ...
    public void getBookmarks(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (Bookmark bookmark : bookmarkService.getBookmarks(username)) {
            org.minisonic.restapi.Bookmark b = new org.minisonic.restapi.Bookmark();
    ...
    public void getPlayQueue(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        org.minisonic.restapi.PlayQueue restPlayQueue = new org.minisonic.restapi.PlayQueue();
    ...
    public void getShares(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (org.minisonic.player.domain.Share share : shareService.getSharesForUser(user)) {
            org.minisonic.restapi.Share s = createJaxbShare(request, share);
    ...
    public void createShare(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        org.minisonic.player.domain.Share share = shareService.createShare(request, files);
    ...
    public void deleteShare(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        org.minisonic.player.domain.Share share = shareService.getShareById(id);
        if (share == null) {
    ...
    private org.minisonic.restapi.Share createJaxbShare(HttpServletRequest request, org.minisonic.player.domain.Share share) {
        org.minisonic.restapi.Share result = new org.minisonic.restapi.Share();
    ...
    public void changePassword(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        org.minisonic.player.domain.User authUser = securityService.getCurrentUser(request);
        ...
        org.minisonic.player.domain.User user = securityService.getUserByName(username);
    ...
    public void getUser(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        org.minisonic.player.domain.User currentUser = securityService.getCurrentUser(request);
        ...
        org.minisonic.player.domain.User requestedUser = securityService.getUserByName(username);
    ...
    public void getUsers(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (org.minisonic.player.domain.User user : securityService.getAllUsers()) {
    ...
    private org.minisonic.restapi.User createJaxbUser(org.minisonic.player.domain.User user) {
        UserSettings userSettings = settingsService.getUserSettings(user.getUsername());

        org.minisonic.restapi.User result = new org.minisonic.restapi.User();
        ...
        // currently this role isn't supported by minisonic
        ...
        List<org.minisonic.player.domain.MusicFolder> musicFolders = settingsService.getMusicFoldersForUser(user.getUsername());
        for (org.minisonic.player.domain.MusicFolder musicFolder : musicFolders) {
    ...
    public void createUser(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (folderIds.length == 0) {
            folderIds = Util.toIntArray(org.minisonic.player.domain.MusicFolder.toIdList(settingsService.getAllMusicFolders()));
        }
    ...
    public void updateUser(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String username = getRequiredStringParameter(request, "username");
        org.minisonic.player.domain.User u = securityService.getUserByName(username);
        UserSettings s = settingsService.getUserSettings(username);

        if (u == null) {
            error(request, response, ErrorCode.NOT_FOUND, "No such user: " + username);
            return;
        } else if (org.minisonic.player.domain.User.USERNAME_ADMIN.equals(username)) {
        ...
        int[] folderIds = ServletRequestUtils.getIntParameters(request, "musicFolderId");
        if (folderIds.length == 0) {
            folderIds = Util.toIntArray(org.minisonic.player.domain.MusicFolder.toIdList(settingsService.getMusicFoldersForUser(username)));
        }
        command.setAllowedMusicFolderIds(folderIds);
    ...
    public void deleteUser(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String username = getRequiredStringParameter(request, "username");
        if (org.minisonic.player.domain.User.USERNAME_ADMIN.equals(username)) {
    ...
    public enum ErrorCode {
        ...
        PROTOCOL_MISMATCH_CLIENT_TOO_OLD(20, "Incompatible Minisonic REST protocol version. Client must upgrade."),
        PROTOCOL_MISMATCH_SERVER_TOO_OLD(30, "Incompatible Minisonic REST protocol version. Server must upgrade."),
    ...
    private static class BookmarkKey extends Pair<String, Integer> {
        ...
        static BookmarkKey forBookmark(org.minisonic.player.domain.Bookmark b) {
