...
import org.minisonic.player.service.ApacheCommonsConfigurationService;
...
public class CustomPropertySourceConfigurer implements
    ...
    public void initialize(ConfigurableWebApplicationContext ctx) {
        ...
        PropertySource ps = new CommonsConfigurationPropertySource("minisonic-pre-init-configs", snapshot);
