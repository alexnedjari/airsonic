 ...
 */
package org.minisonic.player.security;
...
public class RESTRequestParameterProcessingFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        MinisonicRESTController.ErrorCode errorCode = null;
        ...
        if (missingCredentials || version == null || client == null) {
            errorCode = MinisonicRESTController.ErrorCode.MISSING_PARAMETER;
        }
    ...
    private MinisonicRESTController.ErrorCode checkAPIVersion(String version) {
        ...
        if (serverVersion.getMajor() > clientVersion.getMajor()) {
            return MinisonicRESTController.ErrorCode.PROTOCOL_MISMATCH_CLIENT_TOO_OLD;
        } else if (serverVersion.getMajor() < clientVersion.getMajor()) {
            return MinisonicRESTController.ErrorCode.PROTOCOL_MISMATCH_SERVER_TOO_OLD;
    ...
    private MinisonicRESTController.ErrorCode authenticate(HttpServletRequest httpRequest, String username, String password, String salt, String token, Authentication previousAuth) {
        ...
        if (salt != null && token != null) {
            ...
            if (user == null) {
                return MinisonicRESTController.ErrorCode.NOT_AUTHENTICATED;
            }
        ...
        return MinisonicRESTController.ErrorCode.MISSING_PARAMETER;
    }
    ...
    private void sendErrorXml(HttpServletRequest request, HttpServletResponse response, MinisonicRESTController.ErrorCode errorCode) throws IOException {
        try {
