...
import org.minisonic.player.dao.AvatarDao;
import org.minisonic.player.dao.InternetRadioDao;
import org.minisonic.player.dao.MusicFolderDao;
import org.minisonic.player.dao.UserDao;
import org.minisonic.player.domain.*;
import org.minisonic.player.spring.DataSourceConfigType;
...
public class SettingsService {
    ...
    // Minisonic home directory.
    private static final File AIRSONIC_HOME_WINDOWS = new File("c:/minisonic");
    private static final File AIRSONIC_HOME_OTHER = new File("/var/minisonic");
    ...
    private static final String DEFAULT_WELCOME_TITLE = "Welcome to Minisonic!";
    private static final String DEFAULT_WELCOME_SUBTITLE = null;
    private static final String DEFAULT_WELCOME_MESSAGE = "__Welcome to Minisonic!__\n" +
            "\\\\ \\\\\n" +
            "Minisonic is a free, web-based media streamer, providing ubiquitous access to your music. \n" +
            "\\\\ \\\\\n" +
    ...
    private static final String DEFAULT_DLNA_SERVER_NAME = "Minisonic";
    private static final String DEFAULT_DLNA_BASE_LAN_URL = null;
    private static final boolean DEFAULT_SONOS_ENABLED = false;
    private static final String DEFAULT_SONOS_SERVICE_NAME = "Minisonic";
    ...
    private static final String DEFAULT_SMTP_FROM = "minisonic@minisonic.org";
    ...
    private static final String LOCALES_FILE = "/org/minisonic/player/i18n/locales.txt";
    private static final String THEMES_FILE = "/org/minisonic/player/theme/themes.txt";
    ...
    public static synchronized File getMinisonicHome() {

        File home;

        String overrideHome = System.getProperty("minisonic.home");
    ...
    private static String getFileSystemAppName() {
        String home = getMinisonicHome().getPath();
        return home.contains("libresonic") ? "libresonic" : "minisonic";
    }

    public static String getDefaultJDBCUrl() {
        return "jdbc:hsqldb:file:" + getMinisonicHome().getPath() + "/db/" + getFileSystemAppName();
    }

    public static File getLogFile() {
        File minisonicHome = SettingsService.getMinisonicHome();
        return new File(minisonicHome, getFileSystemAppName() + ".log");
    }
        ...
        if (!home.exists() || !home.isDirectory()) {
            ...
            if (!success) {
                String message = "The directory " + home + " does not exist. Please create it and make it writable. " +
                        "(You can override the directory location by specifying -Dminisonic.home=... when " +
    ...
    static File getPropertyFile() {
        File propertyFile = getMinisonicHome();
    ...
    public synchronized Theme[] getAvailableThemes() {
        if (themes == null) {
            ...
            try {
                ...
                themes.add(new Theme("default", "Minisonic default"));
            }
        }
    ...
    /**
     * Returns the "brand" name. Normally, this is just "Minisonic".
     *
