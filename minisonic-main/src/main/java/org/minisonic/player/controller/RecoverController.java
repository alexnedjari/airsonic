    ...
    */
    private boolean emailPassword(String password, String username, String email) {
        ...
        try {
            ...
            message.setSubject("Minisonic Password");
            message.setText("Hi there!\n\n" +
                    "You have requested to reset your Minisonic password.  Please find your new login details below.\n\n" +
                    "Username: " + username + "\n" +
                    "Password: " + password + "\n\n" +
                    "--\n" +
                    "Your Minisonic server\n" +
                    "minisonic.github.io/");
