...
import org.minisonic.restapi.Error;
import org.minisonic.restapi.ObjectFactory;
import org.minisonic.restapi.Response;
import org.minisonic.restapi.ResponseStatus;
...
public class JAXBWriter {
    ...
    private String getRESTProtocolVersion() throws Exception {
        InputStream in = null;
        try {
            in = StringUtil.class.getResourceAsStream("/minisonic-rest-api.xsd");
    ...
    public void writeResponse(HttpServletRequest request, HttpServletResponse httpResponse, Response jaxbResponse) {
        ...
        try {
            ...
            marshaller.marshal(new ObjectFactory().createMinisonicResponse(jaxbResponse), writer);
            if (jsonp) {
                writer.append(");");
            }
    ...
    public void writeErrorResponse(HttpServletRequest request, HttpServletResponse response,
                                   MinisonicRESTController.ErrorCode code, String message) throws Exception {
